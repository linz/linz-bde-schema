...
--
-- Name: appellation_within_bbox(DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, VARCHAR);
--
...
ALTER FUNCTION appellation_within_bbox(DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, VARCHAR) OWNER TO  bde_dba;
REVOKE ALL ON FUNCTION appellation_within_bbox(DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, VARCHAR) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION appellation_within_bbox(DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, VARCHAR) TO bde_admin;
GRANT EXECUTE ON FUNCTION appellation_within_bbox(DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, VARCHAR) TO bde_user;
