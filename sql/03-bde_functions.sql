...
--
-- Name: bde_get_appellation_within_bbox(DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, VARCHAR);
--

CREATE OR REPLACE FUNCTION bde_get_appellation_within_bbox(
...
ALTER FUNCTION bde_get_appellation_within_bbox(DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, VARCHAR) OWNER TO  bde_dba;
REVOKE ALL ON FUNCTION bde_get_appellation_within_bbox(DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, VARCHAR) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION bde_get_appellation_within_bbox(DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, VARCHAR) TO bde_admin;
GRANT EXECUTE ON FUNCTION bde_get_appellation_within_bbox(DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, VARCHAR) TO bde_user;
